CREATE DATABASE IF NOT EXISTS db_catalogo CHARACTER
SET
    utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE DATABASE IF NOT EXISTS db_inventario CHARACTER
SET
    utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE DATABASE IF NOT EXISTS db_ventas CHARACTER
SET
    utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE DATABASE IF NOT EXISTS db_auth CHARACTER
SET
    utf8mb4 COLLATE utf8mb4_unicode_ci;
...
(
    ...
    10.00,
    'Vitaminas',
    'https://images.unsplash.com/photo-1526792060691-9b63e34d3667?w=400'
),
(
    'Complejo B',
    '7501234567800',
    ...
    12.00,
    'Vitaminas',
    'https://images.unsplash.com/photo-1621791748377-031c218e2ace?w=400'
),
(
...
VALUES (
    ...
    (
        'Farmacia Sur',
        'Av. Mariscal Sucre y Quitumbe',
        '0223456781'
    ),
    (
        'Farmacia Valle',
        'Av. Interoceánica Km 2.5',
        '0223456782'
    );
